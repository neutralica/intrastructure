...
import ErrReport, {} from "../error-report/error-report.infra.js";
...
export const $r = {
    ...
    /* checking methods: */
    has_data: (result) => result.success && result.data !== NO_VAL && result.data != undefined,
    is_ok: (result) => typeof result === 'object' &&
        result != null &&
        'success' in result &&
        'data' in result &&
        '__only' in result &&
        result.data === NO_VAL,
    is_xx: (result) => typeof result === "object" &&
        result !== null &&
        "success" in result &&
        '__fail' in result &&
        result.success === false,
};
//# sourceMappingURL=result.infra.js.map